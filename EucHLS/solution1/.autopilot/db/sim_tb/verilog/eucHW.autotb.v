...
`define AUTOTB_TVIN_A_0  "./c.eucHW.autotvin_A_0.dat"
`define AUTOTB_TVIN_A_1  "./c.eucHW.autotvin_A_1.dat"
`define AUTOTB_TVIN_A_2  "./c.eucHW.autotvin_A_2.dat"
`define AUTOTB_TVIN_A_3  "./c.eucHW.autotvin_A_3.dat"
`define AUTOTB_TVIN_A_4  "./c.eucHW.autotvin_A_4.dat"
`define AUTOTB_TVIN_A_5  "./c.eucHW.autotvin_A_5.dat"
`define AUTOTB_TVIN_A_6  "./c.eucHW.autotvin_A_6.dat"
`define AUTOTB_TVIN_A_7  "./c.eucHW.autotvin_A_7.dat"
`define AUTOTB_TVIN_B_0  "./c.eucHW.autotvin_B_0.dat"
`define AUTOTB_TVIN_B_1  "./c.eucHW.autotvin_B_1.dat"
`define AUTOTB_TVIN_B_2  "./c.eucHW.autotvin_B_2.dat"
`define AUTOTB_TVIN_B_3  "./c.eucHW.autotvin_B_3.dat"
`define AUTOTB_TVIN_B_4  "./c.eucHW.autotvin_B_4.dat"
`define AUTOTB_TVIN_B_5  "./c.eucHW.autotvin_B_5.dat"
`define AUTOTB_TVIN_B_6  "./c.eucHW.autotvin_B_6.dat"
`define AUTOTB_TVIN_B_7  "./c.eucHW.autotvin_B_7.dat"
`define AUTOTB_TVIN_A_0_out_wrapc  "./rtl.eucHW.autotvin_A_0.dat"
`define AUTOTB_TVIN_A_1_out_wrapc  "./rtl.eucHW.autotvin_A_1.dat"
`define AUTOTB_TVIN_A_2_out_wrapc  "./rtl.eucHW.autotvin_A_2.dat"
`define AUTOTB_TVIN_A_3_out_wrapc  "./rtl.eucHW.autotvin_A_3.dat"
`define AUTOTB_TVIN_A_4_out_wrapc  "./rtl.eucHW.autotvin_A_4.dat"
`define AUTOTB_TVIN_A_5_out_wrapc  "./rtl.eucHW.autotvin_A_5.dat"
`define AUTOTB_TVIN_A_6_out_wrapc  "./rtl.eucHW.autotvin_A_6.dat"
`define AUTOTB_TVIN_A_7_out_wrapc  "./rtl.eucHW.autotvin_A_7.dat"
`define AUTOTB_TVIN_B_0_out_wrapc  "./rtl.eucHW.autotvin_B_0.dat"
`define AUTOTB_TVIN_B_1_out_wrapc  "./rtl.eucHW.autotvin_B_1.dat"
`define AUTOTB_TVIN_B_2_out_wrapc  "./rtl.eucHW.autotvin_B_2.dat"
`define AUTOTB_TVIN_B_3_out_wrapc  "./rtl.eucHW.autotvin_B_3.dat"
`define AUTOTB_TVIN_B_4_out_wrapc  "./rtl.eucHW.autotvin_B_4.dat"
`define AUTOTB_TVIN_B_5_out_wrapc  "./rtl.eucHW.autotvin_B_5.dat"
`define AUTOTB_TVIN_B_6_out_wrapc  "./rtl.eucHW.autotvin_B_6.dat"
`define AUTOTB_TVIN_B_7_out_wrapc  "./rtl.eucHW.autotvin_B_7.dat"
`define AUTOTB_TVOUT_C  "./c.eucHW.autotvout_C.dat"
`define AUTOTB_TVOUT_C_out_wrapc  "./impl_rtl.eucHW.autotvout_C.dat"
module `AUTOTB_TOP;
