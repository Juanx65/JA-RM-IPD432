...
entry:
  ...
  call fastcc void @copy_in(i8* %A, i8* nonnull align 512 %A_copy, i8* %B, i8* nonnull align 512 %B_copy, i32* %C, i32* nonnull align 512 %C_copy)
  call void @apatb_eucHW_hw(i8* %A_copy, i8* %B_copy, i32* %C_copy)
  call fastcc void @copy_out(i8* %A, i8* nonnull align 512 %A_copy, i8* %B, i8* nonnull align 512 %B_copy, i32* %C, i32* nonnull align 512 %C_copy)
  ret void
}
...
declare void @apatb_eucHW_hw(i8*, i8*, i32*)

define void @eucHW_hw_stub_wrapper(i8*, i8*, i32*) #5 {
entry:
  call void @copy_out(i8* null, i8* %0, i8* null, i8* %1, i32* null, i32* %2)
  call void @eucHW_hw_stub(i8* %0, i8* %1, i32* %2)
