...
architecture behave of eucHW_control_s_axi is
    ...
    constant ADDR_A_0_HIGH : INTEGER := 16#01f#;
    constant ADDR_A_1_BASE : INTEGER := 16#020#;
    constant ADDR_A_1_HIGH : INTEGER := 16#02f#;
    constant ADDR_A_2_BASE : INTEGER := 16#030#;
    constant ADDR_A_2_HIGH : INTEGER := 16#03f#;
    constant ADDR_A_3_BASE : INTEGER := 16#040#;
    constant ADDR_A_3_HIGH : INTEGER := 16#04f#;
    constant ADDR_A_4_BASE : INTEGER := 16#050#;
    constant ADDR_A_4_HIGH : INTEGER := 16#05f#;
    constant ADDR_A_5_BASE : INTEGER := 16#060#;
    constant ADDR_A_5_HIGH : INTEGER := 16#06f#;
    constant ADDR_A_6_BASE : INTEGER := 16#070#;
    constant ADDR_A_6_HIGH : INTEGER := 16#07f#;
    constant ADDR_A_7_BASE : INTEGER := 16#080#;
    constant ADDR_A_7_HIGH : INTEGER := 16#08f#;
    constant ADDR_B_0_BASE : INTEGER := 16#090#;
    constant ADDR_B_0_HIGH : INTEGER := 16#09f#;
    constant ADDR_B_1_BASE : INTEGER := 16#0a0#;
    constant ADDR_B_1_HIGH : INTEGER := 16#0af#;
    constant ADDR_B_2_BASE : INTEGER := 16#0b0#;
    constant ADDR_B_2_HIGH : INTEGER := 16#0bf#;
    constant ADDR_B_3_BASE : INTEGER := 16#0c0#;
    constant ADDR_B_3_HIGH : INTEGER := 16#0cf#;
    constant ADDR_B_4_BASE : INTEGER := 16#0d0#;
    constant ADDR_B_4_HIGH : INTEGER := 16#0df#;
    constant ADDR_B_5_BASE : INTEGER := 16#0e0#;
    constant ADDR_B_5_HIGH : INTEGER := 16#0ef#;
    constant ADDR_B_6_BASE : INTEGER := 16#0f0#;
    constant ADDR_B_6_HIGH : INTEGER := 16#0ff#;
    constant ADDR_B_7_BASE : INTEGER := 16#100#;
    constant ADDR_B_7_HIGH : INTEGER := 16#10f#;
    ...
    -- memory signals
    signal int_A_0_address0    : UNSIGNED(1 downto 0);
    signal int_A_0_ce0         : STD_LOGIC;
    signal int_A_0_q0          : UNSIGNED(31 downto 0);
    signal int_A_0_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_A_1_address0    : UNSIGNED(1 downto 0);
    signal int_A_1_ce0         : STD_LOGIC;
    signal int_A_1_q0          : UNSIGNED(31 downto 0);
    signal int_A_1_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_A_2_address0    : UNSIGNED(1 downto 0);
    signal int_A_2_ce0         : STD_LOGIC;
    signal int_A_2_q0          : UNSIGNED(31 downto 0);
    signal int_A_2_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_A_3_address0    : UNSIGNED(1 downto 0);
    signal int_A_3_ce0         : STD_LOGIC;
    signal int_A_3_q0          : UNSIGNED(31 downto 0);
    signal int_A_3_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_A_4_address0    : UNSIGNED(1 downto 0);
    signal int_A_4_ce0         : STD_LOGIC;
    signal int_A_4_q0          : UNSIGNED(31 downto 0);
    signal int_A_4_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_A_5_address0    : UNSIGNED(1 downto 0);
    signal int_A_5_ce0         : STD_LOGIC;
    signal int_A_5_q0          : UNSIGNED(31 downto 0);
    signal int_A_5_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_A_6_address0    : UNSIGNED(1 downto 0);
    signal int_A_6_ce0         : STD_LOGIC;
    signal int_A_6_q0          : UNSIGNED(31 downto 0);
    signal int_A_6_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_A_7_address0    : UNSIGNED(1 downto 0);
    signal int_A_7_ce0         : STD_LOGIC;
    signal int_A_7_q0          : UNSIGNED(31 downto 0);
    signal int_A_7_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_B_0_address0    : UNSIGNED(1 downto 0);
    signal int_B_0_ce0         : STD_LOGIC;
    signal int_B_0_q0          : UNSIGNED(31 downto 0);
    signal int_B_0_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_B_1_address0    : UNSIGNED(1 downto 0);
    signal int_B_1_ce0         : STD_LOGIC;
    signal int_B_1_q0          : UNSIGNED(31 downto 0);
    signal int_B_1_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_B_2_address0    : UNSIGNED(1 downto 0);
    signal int_B_2_ce0         : STD_LOGIC;
    signal int_B_2_q0          : UNSIGNED(31 downto 0);
    signal int_B_2_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_B_3_address0    : UNSIGNED(1 downto 0);
    signal int_B_3_ce0         : STD_LOGIC;
    signal int_B_3_q0          : UNSIGNED(31 downto 0);
    signal int_B_3_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_B_4_address0    : UNSIGNED(1 downto 0);
    signal int_B_4_ce0         : STD_LOGIC;
    signal int_B_4_q0          : UNSIGNED(31 downto 0);
    signal int_B_4_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_B_5_address0    : UNSIGNED(1 downto 0);
    signal int_B_5_ce0         : STD_LOGIC;
    signal int_B_5_q0          : UNSIGNED(31 downto 0);
    signal int_B_5_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_B_6_address0    : UNSIGNED(1 downto 0);
    signal int_B_6_ce0         : STD_LOGIC;
    signal int_B_6_q0          : UNSIGNED(31 downto 0);
    signal int_B_6_address1    : UNSIGNED(1 downto 0);
    ...
    signal int_B_7_address0    : UNSIGNED(1 downto 0);
    signal int_B_7_ce0         : STD_LOGIC;
    signal int_B_7_q0          : UNSIGNED(31 downto 0);
    signal int_B_7_address1    : UNSIGNED(1 downto 0);
...
-- ----------------------- Memory logic ------------------
    -- A_0
    int_A_0_address0     <= SHIFT_RIGHT(UNSIGNED(A_0_address0), 2)(1 downto 0);
    int_A_0_ce0          <= A_0_ce0;
    A_0_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_0_q0, TO_INTEGER(int_A_0_shift0) * 8)(7 downto 0));
    int_A_0_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- A_1
    int_A_1_address0     <= SHIFT_RIGHT(UNSIGNED(A_1_address0), 2)(1 downto 0);
    int_A_1_ce0          <= A_1_ce0;
    A_1_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_1_q0, TO_INTEGER(int_A_1_shift0) * 8)(7 downto 0));
    int_A_1_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- A_2
    int_A_2_address0     <= SHIFT_RIGHT(UNSIGNED(A_2_address0), 2)(1 downto 0);
    int_A_2_ce0          <= A_2_ce0;
    A_2_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_2_q0, TO_INTEGER(int_A_2_shift0) * 8)(7 downto 0));
    int_A_2_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- A_3
    int_A_3_address0     <= SHIFT_RIGHT(UNSIGNED(A_3_address0), 2)(1 downto 0);
    int_A_3_ce0          <= A_3_ce0;
    A_3_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_3_q0, TO_INTEGER(int_A_3_shift0) * 8)(7 downto 0));
    int_A_3_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- A_4
    int_A_4_address0     <= SHIFT_RIGHT(UNSIGNED(A_4_address0), 2)(1 downto 0);
    int_A_4_ce0          <= A_4_ce0;
    A_4_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_4_q0, TO_INTEGER(int_A_4_shift0) * 8)(7 downto 0));
    int_A_4_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- A_5
    int_A_5_address0     <= SHIFT_RIGHT(UNSIGNED(A_5_address0), 2)(1 downto 0);
    int_A_5_ce0          <= A_5_ce0;
    A_5_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_5_q0, TO_INTEGER(int_A_5_shift0) * 8)(7 downto 0));
    int_A_5_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- A_6
    int_A_6_address0     <= SHIFT_RIGHT(UNSIGNED(A_6_address0), 2)(1 downto 0);
    int_A_6_ce0          <= A_6_ce0;
    A_6_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_6_q0, TO_INTEGER(int_A_6_shift0) * 8)(7 downto 0));
    int_A_6_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- A_7
    int_A_7_address0     <= SHIFT_RIGHT(UNSIGNED(A_7_address0), 2)(1 downto 0);
    int_A_7_ce0          <= A_7_ce0;
    A_7_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_7_q0, TO_INTEGER(int_A_7_shift0) * 8)(7 downto 0));
    int_A_7_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- B_0
    int_B_0_address0     <= SHIFT_RIGHT(UNSIGNED(B_0_address0), 2)(1 downto 0);
    int_B_0_ce0          <= B_0_ce0;
    B_0_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_B_0_q0, TO_INTEGER(int_B_0_shift0) * 8)(7 downto 0));
    int_B_0_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- B_1
    int_B_1_address0     <= SHIFT_RIGHT(UNSIGNED(B_1_address0), 2)(1 downto 0);
    int_B_1_ce0          <= B_1_ce0;
    B_1_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_B_1_q0, TO_INTEGER(int_B_1_shift0) * 8)(7 downto 0));
    int_B_1_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- B_2
    int_B_2_address0     <= SHIFT_RIGHT(UNSIGNED(B_2_address0), 2)(1 downto 0);
    int_B_2_ce0          <= B_2_ce0;
    B_2_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_B_2_q0, TO_INTEGER(int_B_2_shift0) * 8)(7 downto 0));
    int_B_2_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- B_3
    int_B_3_address0     <= SHIFT_RIGHT(UNSIGNED(B_3_address0), 2)(1 downto 0);
    int_B_3_ce0          <= B_3_ce0;
    B_3_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_B_3_q0, TO_INTEGER(int_B_3_shift0) * 8)(7 downto 0));
    int_B_3_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- B_4
    int_B_4_address0     <= SHIFT_RIGHT(UNSIGNED(B_4_address0), 2)(1 downto 0);
    int_B_4_ce0          <= B_4_ce0;
    B_4_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_B_4_q0, TO_INTEGER(int_B_4_shift0) * 8)(7 downto 0));
    int_B_4_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- B_5
    int_B_5_address0     <= SHIFT_RIGHT(UNSIGNED(B_5_address0), 2)(1 downto 0);
    int_B_5_ce0          <= B_5_ce0;
    B_5_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_B_5_q0, TO_INTEGER(int_B_5_shift0) * 8)(7 downto 0));
    int_B_5_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- B_6
    int_B_6_address0     <= SHIFT_RIGHT(UNSIGNED(B_6_address0), 2)(1 downto 0);
    int_B_6_ce0          <= B_6_ce0;
    B_6_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_B_6_q0, TO_INTEGER(int_B_6_shift0) * 8)(7 downto 0));
    int_B_6_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
    ...
    -- B_7
    int_B_7_address0     <= SHIFT_RIGHT(UNSIGNED(B_7_address0), 2)(1 downto 0);
    int_B_7_ce0          <= B_7_ce0;
    B_7_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_B_7_q0, TO_INTEGER(int_B_7_shift0) * 8)(7 downto 0));
    int_B_7_address1     <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
