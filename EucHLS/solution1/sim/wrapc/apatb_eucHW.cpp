...
extern "C" void eucHW_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_A_0)[j];
  ...
  tcl_file.set_num(16, &tcl_file.A_0_depth);
...
// print A_1 Transactions
{
  ...
  if (__xlx_apatb_param_A_1) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_A_1)[j];
  ...
  tcl_file.set_num(16, &tcl_file.A_1_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_1, __xlx_sprintf_buffer.data());
}
...
// print A_2 Transactions
{
  ...
  {  __xlx_offset_byte_param_A_2 = 0*1;
  if (__xlx_apatb_param_A_2) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_A_2)[j];
  ...
  tcl_file.set_num(16, &tcl_file.A_2_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_2, __xlx_sprintf_buffer.data());
}
...
// print A_3 Transactions
{
  ...
  {  __xlx_offset_byte_param_A_3 = 0*1;
  if (__xlx_apatb_param_A_3) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_A_3)[j];
  ...
  tcl_file.set_num(16, &tcl_file.A_3_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_3, __xlx_sprintf_buffer.data());
}
...
// print A_4 Transactions
{
  ...
  {  __xlx_offset_byte_param_A_4 = 0*1;
  if (__xlx_apatb_param_A_4) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_A_4)[j];
  ...
  tcl_file.set_num(16, &tcl_file.A_4_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_4, __xlx_sprintf_buffer.data());
}
...
// print A_5 Transactions
{
  ...
  {  __xlx_offset_byte_param_A_5 = 0*1;
  if (__xlx_apatb_param_A_5) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_A_5)[j];
  ...
  tcl_file.set_num(16, &tcl_file.A_5_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_5, __xlx_sprintf_buffer.data());
}
...
// print A_6 Transactions
{
  ...
  {  __xlx_offset_byte_param_A_6 = 0*1;
  if (__xlx_apatb_param_A_6) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_A_6)[j];
  ...
  tcl_file.set_num(16, &tcl_file.A_6_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_6, __xlx_sprintf_buffer.data());
}
...
// print A_7 Transactions
{
  ...
  {  __xlx_offset_byte_param_A_7 = 0*1;
  if (__xlx_apatb_param_A_7) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_A_7)[j];
  ...
  tcl_file.set_num(16, &tcl_file.A_7_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_7, __xlx_sprintf_buffer.data());
}
...
// print B_0 Transactions
{
  ...
  if (__xlx_apatb_param_B_0) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_B_0)[j];
  ...
  tcl_file.set_num(16, &tcl_file.B_0_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_B_0, __xlx_sprintf_buffer.data());
}
...
// print B_1 Transactions
{
  ...
  if (__xlx_apatb_param_B_1) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_B_1)[j];
  ...
  tcl_file.set_num(16, &tcl_file.B_1_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_B_1, __xlx_sprintf_buffer.data());
}
...
// print B_2 Transactions
{
  ...
  if (__xlx_apatb_param_B_2) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_B_2)[j];
  ...
  tcl_file.set_num(16, &tcl_file.B_2_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_B_2, __xlx_sprintf_buffer.data());
}
...
// print B_3 Transactions
{
  ...
  {  __xlx_offset_byte_param_B_3 = 0*1;
  if (__xlx_apatb_param_B_3) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_B_3)[j];
  ...
  tcl_file.set_num(16, &tcl_file.B_3_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_B_3, __xlx_sprintf_buffer.data());
}
...
// print B_4 Transactions
{
  ...
  {  __xlx_offset_byte_param_B_4 = 0*1;
  if (__xlx_apatb_param_B_4) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_B_4)[j];
  ...
  tcl_file.set_num(16, &tcl_file.B_4_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_B_4, __xlx_sprintf_buffer.data());
}
...
// print B_5 Transactions
{
  ...
  {  __xlx_offset_byte_param_B_5 = 0*1;
  if (__xlx_apatb_param_B_5) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_B_5)[j];
  ...
  tcl_file.set_num(16, &tcl_file.B_5_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_B_5, __xlx_sprintf_buffer.data());
}
...
// print B_6 Transactions
{
  ...
  {  __xlx_offset_byte_param_B_6 = 0*1;
  if (__xlx_apatb_param_B_6) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_B_6)[j];
  ...
  tcl_file.set_num(16, &tcl_file.B_6_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_B_6, __xlx_sprintf_buffer.data());
}
...
// print B_7 Transactions
{
  ...
  {  __xlx_offset_byte_param_B_7 = 0*1;
  if (__xlx_apatb_param_B_7) {
    for (int j = 0  - 0, e = 16 - 0; j != e; ++j) {
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_B_7)[j];
  ...
  tcl_file.set_num(16, &tcl_file.B_7_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_B_7, __xlx_sprintf_buffer.data());
}
