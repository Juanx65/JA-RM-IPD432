...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "eucHW_RC.autotvin.dat"
	set constFileTvOut       "eucHW_RC.autotvout.dat"
	set constFileHdlTvIn     "eucHW_RC.autohdltvin.dat"
	set constFileHdlTvOut    "eucHW_RC.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
