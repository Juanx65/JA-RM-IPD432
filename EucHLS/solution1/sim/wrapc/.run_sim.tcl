...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "eucHW.autotvin.dat"
	set constFileTvOut       "eucHW.autotvout.dat"
	set constFileHdlTvIn     "eucHW.autohdltvin.dat"
	set constFileHdlTvOut    "eucHW.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
