...
define void @apatb_eucHW_RC_ir(i8* %A, i8* %B, i32* %C) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_eucHW_RC_hw(i8192* %A_copy1, i8192* %B_copy2, i32* %3)
...
declare void @apatb_eucHW_RC_hw(i8192*, i8192*, i32*)

define void @eucHW_RC_hw_stub_wrapper(i8192*, i8192*, i32*) #5 {
entry:
  %3 = alloca [1024 x i8]
  %4 = alloca [1024 x i8]
  ...
  call void @eucHW_RC_hw_stub(i8* %6, i8* %7, i32* %8)
  call void @copy_in([1024 x i8]* %3, i8192* %0, [1024 x i8]* %4, i8192* %1, [1 x i32]* null, [1 x i32]* %5)
  ret void
}

declare void @eucHW_RC_hw_stub(i8*, i8*, i32*)
