...
//------------------------Parameter----------------------
`define TV_IN_A_0 "../tv/cdatafile/c.eucHW.autotvin_A_0.dat"
`define TV_IN_A_1 "../tv/cdatafile/c.eucHW.autotvin_A_1.dat"
`define TV_IN_A_2 "../tv/cdatafile/c.eucHW.autotvin_A_2.dat"
`define TV_IN_A_3 "../tv/cdatafile/c.eucHW.autotvin_A_3.dat"
`define TV_IN_A_4 "../tv/cdatafile/c.eucHW.autotvin_A_4.dat"
`define TV_IN_A_5 "../tv/cdatafile/c.eucHW.autotvin_A_5.dat"
`define TV_IN_A_6 "../tv/cdatafile/c.eucHW.autotvin_A_6.dat"
`define TV_IN_A_7 "../tv/cdatafile/c.eucHW.autotvin_A_7.dat"
`define TV_IN_B_0 "../tv/cdatafile/c.eucHW.autotvin_B_0.dat"
`define TV_IN_B_1 "../tv/cdatafile/c.eucHW.autotvin_B_1.dat"
`define TV_IN_B_2 "../tv/cdatafile/c.eucHW.autotvin_B_2.dat"
`define TV_IN_B_3 "../tv/cdatafile/c.eucHW.autotvin_B_3.dat"
`define TV_IN_B_4 "../tv/cdatafile/c.eucHW.autotvin_B_4.dat"
`define TV_IN_B_5 "../tv/cdatafile/c.eucHW.autotvin_B_5.dat"
`define TV_IN_B_6 "../tv/cdatafile/c.eucHW.autotvin_B_6.dat"
`define TV_IN_B_7 "../tv/cdatafile/c.eucHW.autotvin_B_7.dat"
`define TV_OUT_C "../tv/rtldatafile/rtl.eucHW.autotvout_C.dat"
parameter ADDR_WIDTH = 9;
parameter DATA_WIDTH = 32;
parameter A_0_DEPTH = 16;
reg [31 : 0] A_0_OPERATE_DEPTH = 0;
parameter A_0_c_bitwidth = 8;
parameter A_1_DEPTH = 16;
reg [31 : 0] A_1_OPERATE_DEPTH = 0;
parameter A_1_c_bitwidth = 8;
parameter A_2_DEPTH = 16;
reg [31 : 0] A_2_OPERATE_DEPTH = 0;
parameter A_2_c_bitwidth = 8;
parameter A_3_DEPTH = 16;
reg [31 : 0] A_3_OPERATE_DEPTH = 0;
parameter A_3_c_bitwidth = 8;
parameter A_4_DEPTH = 16;
reg [31 : 0] A_4_OPERATE_DEPTH = 0;
parameter A_4_c_bitwidth = 8;
parameter A_5_DEPTH = 16;
reg [31 : 0] A_5_OPERATE_DEPTH = 0;
parameter A_5_c_bitwidth = 8;
parameter A_6_DEPTH = 16;
reg [31 : 0] A_6_OPERATE_DEPTH = 0;
parameter A_6_c_bitwidth = 8;
parameter A_7_DEPTH = 16;
reg [31 : 0] A_7_OPERATE_DEPTH = 0;
parameter A_7_c_bitwidth = 8;
parameter B_0_DEPTH = 16;
reg [31 : 0] B_0_OPERATE_DEPTH = 0;
parameter B_0_c_bitwidth = 8;
parameter B_1_DEPTH = 16;
reg [31 : 0] B_1_OPERATE_DEPTH = 0;
parameter B_1_c_bitwidth = 8;
parameter B_2_DEPTH = 16;
reg [31 : 0] B_2_OPERATE_DEPTH = 0;
parameter B_2_c_bitwidth = 8;
parameter B_3_DEPTH = 16;
reg [31 : 0] B_3_OPERATE_DEPTH = 0;
parameter B_3_c_bitwidth = 8;
parameter B_4_DEPTH = 16;
reg [31 : 0] B_4_OPERATE_DEPTH = 0;
parameter B_4_c_bitwidth = 8;
parameter B_5_DEPTH = 16;
reg [31 : 0] B_5_OPERATE_DEPTH = 0;
parameter B_5_c_bitwidth = 8;
parameter B_6_DEPTH = 16;
reg [31 : 0] B_6_OPERATE_DEPTH = 0;
parameter B_6_c_bitwidth = 8;
parameter B_7_DEPTH = 16;
reg [31 : 0] B_7_OPERATE_DEPTH = 0;
parameter B_7_c_bitwidth = 8;
parameter C_DEPTH = 1;
reg [31 : 0] C_OPERATE_DEPTH = 0;
parameter C_c_bitwidth = 32;
parameter START_ADDR = 0;
parameter eucHW_continue_addr = 0;
parameter eucHW_auto_start_addr = 0;
parameter A_0_data_in_addr = 16;
parameter A_1_data_in_addr = 32;
parameter A_2_data_in_addr = 48;
parameter A_3_data_in_addr = 64;
parameter A_4_data_in_addr = 80;
parameter A_5_data_in_addr = 96;
parameter A_6_data_in_addr = 112;
parameter A_7_data_in_addr = 128;
parameter B_0_data_in_addr = 144;
parameter B_1_data_in_addr = 160;
parameter B_2_data_in_addr = 176;
parameter B_3_data_in_addr = 192;
parameter B_4_data_in_addr = 208;
parameter B_5_data_in_addr = 224;
parameter B_6_data_in_addr = 240;
parameter B_7_data_in_addr = 256;
parameter C_data_out_addr = 272;
parameter C_valid_out_addr = 276;
...
always @(reset or posedge clk) begin
    if (reset == 0) begin
        ...
        if (write_start_count >= 100) begin
            write_start_run_flag <= 0; 
        end
