...
architecture behave of eucHW_control_s_axi is
    ...
    constant ADDR_C_DATA_0 : INTEGER := 16#90#;
    constant ADDR_C_CTRL   : INTEGER := 16#94#;
    constant ADDR_A_0_BASE : INTEGER := 16#10#;
    constant ADDR_A_0_HIGH : INTEGER := 16#17#;
    constant ADDR_A_1_BASE : INTEGER := 16#18#;
    constant ADDR_A_1_HIGH : INTEGER := 16#1f#;
    constant ADDR_A_2_BASE : INTEGER := 16#20#;
    constant ADDR_A_2_HIGH : INTEGER := 16#27#;
    constant ADDR_A_3_BASE : INTEGER := 16#28#;
    constant ADDR_A_3_HIGH : INTEGER := 16#2f#;
    constant ADDR_A_4_BASE : INTEGER := 16#30#;
    constant ADDR_A_4_HIGH : INTEGER := 16#37#;
    constant ADDR_A_5_BASE : INTEGER := 16#38#;
    constant ADDR_A_5_HIGH : INTEGER := 16#3f#;
    constant ADDR_A_6_BASE : INTEGER := 16#40#;
    constant ADDR_A_6_HIGH : INTEGER := 16#47#;
    constant ADDR_A_7_BASE : INTEGER := 16#48#;
    constant ADDR_A_7_HIGH : INTEGER := 16#4f#;
    constant ADDR_B_0_BASE : INTEGER := 16#50#;
    constant ADDR_B_0_HIGH : INTEGER := 16#57#;
    constant ADDR_B_1_BASE : INTEGER := 16#58#;
    constant ADDR_B_1_HIGH : INTEGER := 16#5f#;
    constant ADDR_B_2_BASE : INTEGER := 16#60#;
    constant ADDR_B_2_HIGH : INTEGER := 16#67#;
    constant ADDR_B_3_BASE : INTEGER := 16#68#;
    constant ADDR_B_3_HIGH : INTEGER := 16#6f#;
    constant ADDR_B_4_BASE : INTEGER := 16#70#;
    constant ADDR_B_4_HIGH : INTEGER := 16#77#;
    constant ADDR_B_5_BASE : INTEGER := 16#78#;
    constant ADDR_B_5_HIGH : INTEGER := 16#7f#;
    constant ADDR_B_6_BASE : INTEGER := 16#80#;
    constant ADDR_B_6_HIGH : INTEGER := 16#87#;
    constant ADDR_B_7_BASE : INTEGER := 16#88#;
    constant ADDR_B_7_HIGH : INTEGER := 16#8f#;
