...
set genomeRtd $env(RT_TMP)/1A2244E2760.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {eucHW__GB1}]"
...
set genomeName [subst -nocommands -novariables {eucHW__GB1}]
