...
set genomeRtd $env(RT_TMP)/14D55753EB0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {eucHW_0_GT3__1}]"
...
set genomeName [subst -nocommands -novariables {eucHW_0_GT3__1}]
