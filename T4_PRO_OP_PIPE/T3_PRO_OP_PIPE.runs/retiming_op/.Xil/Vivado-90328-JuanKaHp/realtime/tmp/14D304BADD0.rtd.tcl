...
set genomeRtd $env(RT_TMP)/14D304BADD0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {eucHW_RC__GB2}]"
...
set genomeName [subst -nocommands -novariables {eucHW_RC__GB2}]
