...
set genomeRtd $env(RT_TMP)/2AB8E01C5D0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {eucHW_sub_8192ns_8192ns_8192_2_1_Adder_0__GC0}]"
...
set genomeName [subst -nocommands -novariables {eucHW_sub_8192ns_8192ns_8192_2_1_Adder_0__GC0}]
