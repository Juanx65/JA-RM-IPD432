...
set genomeRtd $env(RT_TMP)/2AB885D6960.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {eucHW_sub_8192ns_8192ns_8192_2_1_Adder_0_comb_adder}]"
...
set genomeName [subst -nocommands -novariables {eucHW_sub_8192ns_8192ns_8192_2_1_Adder_0_comb_adder}]
