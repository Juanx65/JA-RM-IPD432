...
#
# Generated by export_simulation on Mon Mar 14 23:59:09 -0300 2022
#
################################################################################
...
'-reset_run' switch to the './eucHW_1.sh' script.

./eucHW_1.sh -reset_run
...
./eucHW_1.sh -noclean_files

For more information on the script, please type './eucHW_1.sh -help'.
