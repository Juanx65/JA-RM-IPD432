...
#
# Generated by Vivado on Mon Mar 14 17:33:41 -0300 2022
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot eucHW_0 xil_defaultlib.eucHW_0 xil_defaultlib.glbl -log elaborate.log
}
