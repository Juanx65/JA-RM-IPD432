...
entry:
  ...
  %A_copy_2 = alloca [8 x i8], align 512
  %A_copy_3 = alloca [8 x i8], align 512
  %A_copy_4 = alloca [8 x i8], align 512
  %A_copy_5 = alloca [8 x i8], align 512
  %A_copy_6 = alloca [8 x i8], align 512
  %A_copy_7 = alloca [8 x i8], align 512
  %B_copy_0 = alloca [8 x i8], align 512
  %B_copy_1 = alloca [8 x i8], align 512
  %B_copy_2 = alloca [8 x i8], align 512
  %B_copy_3 = alloca [8 x i8], align 512
  %B_copy_4 = alloca [8 x i8], align 512
  %B_copy_5 = alloca [8 x i8], align 512
  %B_copy_6 = alloca [8 x i8], align 512
  %B_copy_7 = alloca [8 x i8], align 512
  %C_copy = alloca [1 x i32], align 512
  %0 = bitcast i8* %A to [64 x i8]*
  %1 = bitcast i8* %B to [64 x i8]*
  %2 = bitcast i32* %C to [1 x i32]*
  call void @copy_in([64 x i8]* %0, [8 x i8]* nonnull align 512 %A_copy_0, [8 x i8]* nonnull align 512 %A_copy_1, [8 x i8]* nonnull align 512 %A_copy_2, [8 x i8]* nonnull align 512 %A_copy_3, [8 x i8]* nonnull align 512 %A_copy_4, [8 x i8]* nonnull align 512 %A_copy_5, [8 x i8]* nonnull align 512 %A_copy_6, [8 x i8]* nonnull align 512 %A_copy_7, [64 x i8]* %1, [8 x i8]* nonnull align 512 %B_copy_0, [8 x i8]* nonnull align 512 %B_copy_1, [8 x i8]* nonnull align 512 %B_copy_2, [8 x i8]* nonnull align 512 %B_copy_3, [8 x i8]* nonnull align 512 %B_copy_4, [8 x i8]* nonnull align 512 %B_copy_5, [8 x i8]* nonnull align 512 %B_copy_6, [8 x i8]* nonnull align 512 %B_copy_7, [1 x i32]* %2, [1 x i32]* nonnull align 512 %C_copy)
  %_0 = bitcast [8 x i8]* %A_copy_0 to i8*
  %_1 = bitcast [8 x i8]* %A_copy_1 to i8*
  %_2 = bitcast [8 x i8]* %A_copy_2 to i8*
  %_3 = bitcast [8 x i8]* %A_copy_3 to i8*
  %_4 = bitcast [8 x i8]* %A_copy_4 to i8*
  %_5 = bitcast [8 x i8]* %A_copy_5 to i8*
  %_6 = bitcast [8 x i8]* %A_copy_6 to i8*
  %_7 = bitcast [8 x i8]* %A_copy_7 to i8*
  %_01 = bitcast [8 x i8]* %B_copy_0 to i8*
  %_12 = bitcast [8 x i8]* %B_copy_1 to i8*
  %_23 = bitcast [8 x i8]* %B_copy_2 to i8*
  %_34 = bitcast [8 x i8]* %B_copy_3 to i8*
  %_45 = bitcast [8 x i8]* %B_copy_4 to i8*
  %_56 = bitcast [8 x i8]* %B_copy_5 to i8*
  %_67 = bitcast [8 x i8]* %B_copy_6 to i8*
  %_78 = bitcast [8 x i8]* %B_copy_7 to i8*
  ...
  call void @apatb_eucHW_hw([8 x i8]* %A_copy_0, [8 x i8]* %A_copy_1, [8 x i8]* %A_copy_2, [8 x i8]* %A_copy_3, [8 x i8]* %A_copy_4, [8 x i8]* %A_copy_5, [8 x i8]* %A_copy_6, [8 x i8]* %A_copy_7, [8 x i8]* %B_copy_0, [8 x i8]* %B_copy_1, [8 x i8]* %B_copy_2, [8 x i8]* %B_copy_3, [8 x i8]* %B_copy_4, [8 x i8]* %B_copy_5, [8 x i8]* %B_copy_6, [8 x i8]* %B_copy_7, i32* %3)
  call void @copy_out([64 x i8]* %0, [8 x i8]* nonnull align 512 %A_copy_0, [8 x i8]* nonnull align 512 %A_copy_1, [8 x i8]* nonnull align 512 %A_copy_2, [8 x i8]* nonnull align 512 %A_copy_3, [8 x i8]* nonnull align 512 %A_copy_4, [8 x i8]* nonnull align 512 %A_copy_5, [8 x i8]* nonnull align 512 %A_copy_6, [8 x i8]* nonnull align 512 %A_copy_7, [64 x i8]* %1, [8 x i8]* nonnull align 512 %B_copy_0, [8 x i8]* nonnull align 512 %B_copy_1, [8 x i8]* nonnull align 512 %B_copy_2, [8 x i8]* nonnull align 512 %B_copy_3, [8 x i8]* nonnull align 512 %B_copy_4, [8 x i8]* nonnull align 512 %B_copy_5, [8 x i8]* nonnull align 512 %B_copy_6, [8 x i8]* nonnull align 512 %B_copy_7, [1 x i32]* %2, [1 x i32]* nonnull align 512 %C_copy)
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal void @onebyonecpy_hls.p0a64i8.15.16([8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_2, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_3, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_4, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_5, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_6, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_7, [64 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
  %1 = icmp eq [8 x i8]* %_0, null
...
for.loop:                                         ; preds = %dst.addr.exit, %copy
  ...
  %dst.addr_0 = getelementptr [8 x i8], [8 x i8]* %_0, i64 0, i64 %5
  %dst.addr_1 = getelementptr [8 x i8], [8 x i8]* %_1, i64 0, i64 %5
  %dst.addr_2 = getelementptr [8 x i8], [8 x i8]* %_2, i64 0, i64 %5
  %dst.addr_3 = getelementptr [8 x i8], [8 x i8]* %_3, i64 0, i64 %5
  %dst.addr_4 = getelementptr [8 x i8], [8 x i8]* %_4, i64 0, i64 %5
  %dst.addr_5 = getelementptr [8 x i8], [8 x i8]* %_5, i64 0, i64 %5
  %dst.addr_6 = getelementptr [8 x i8], [8 x i8]* %_6, i64 0, i64 %5
  %dst.addr_7 = getelementptr [8 x i8], [8 x i8]* %_7, i64 0, i64 %5
  %src.addr = getelementptr [64 x i8], [64 x i8]* %0, i64 0, i64 %for.loop.idx1
...
; Function Attrs: argmemonly noinline
define internal void @copy_in([64 x i8]* readonly "orig.arg.no"="0", [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_4, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_5, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_6, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_7, [64 x i8]* readonly "orig.arg.no"="2", [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_23, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_34, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_45, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_56, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_67, [8 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_78, [1 x i32]* readonly "orig.arg.no"="4", [1 x i32]* noalias align 512 "orig.arg.no"="5") #5 {
entry:
  call void @onebyonecpy_hls.p0a64i8.15.16([8 x i8]* align 512 %_0, [8 x i8]* align 512 %_1, [8 x i8]* align 512 %_2, [8 x i8]* align 512 %_3, [8 x i8]* align 512 %_4, [8 x i8]* align 512 %_5, [8 x i8]* align 512 %_6, [8 x i8]* align 512 %_7, [64 x i8]* %0)
  call void @onebyonecpy_hls.p0a64i8.15.16([8 x i8]* align 512 %_01, [8 x i8]* align 512 %_12, [8 x i8]* align 512 %_23, [8 x i8]* align 512 %_34, [8 x i8]* align 512 %_45, [8 x i8]* align 512 %_56, [8 x i8]* align 512 %_67, [8 x i8]* align 512 %_78, [64 x i8]* %1)
  call fastcc void @onebyonecpy_hls.p0a1i32([1 x i32]* align 512 %3, [1 x i32]* %2)
  ret void
}

; Function Attrs: argmemonly noinline
define internal void @onebyonecpy_hls.p0a64i8.21.22([64 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_4, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_5, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_6, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_7) #3 {
entry:
  %1 = icmp eq [64 x i8]* %0, null
  %2 = icmp eq [8 x i8]* %_0, null
  %3 = or i1 %1, %2
  br i1 %3, label %ret, label %copy
...
for.loop:                                         ; preds = %src.addr.exit, %copy
  ...
  %4 = urem i64 %for.loop.idx1, 8
  %5 = udiv i64 %for.loop.idx1, 8
  %src.addr_0 = getelementptr [8 x i8], [8 x i8]* %_0, i64 0, i64 %5
  %src.addr_1 = getelementptr [8 x i8], [8 x i8]* %_1, i64 0, i64 %5
  %src.addr_2 = getelementptr [8 x i8], [8 x i8]* %_2, i64 0, i64 %5
  %src.addr_3 = getelementptr [8 x i8], [8 x i8]* %_3, i64 0, i64 %5
  %src.addr_4 = getelementptr [8 x i8], [8 x i8]* %_4, i64 0, i64 %5
  %src.addr_5 = getelementptr [8 x i8], [8 x i8]* %_5, i64 0, i64 %5
  %src.addr_6 = getelementptr [8 x i8], [8 x i8]* %_6, i64 0, i64 %5
  %src.addr_7 = getelementptr [8 x i8], [8 x i8]* %_7, i64 0, i64 %5
...
; Function Attrs: argmemonly noinline
define internal void @copy_out([64 x i8]* "orig.arg.no"="0", [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_4, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_5, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_6, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_7, [64 x i8]* "orig.arg.no"="2", [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_23, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_34, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_45, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_56, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_67, [8 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_78, [1 x i32]* "orig.arg.no"="4", [1 x i32]* noalias readonly align 512 "orig.arg.no"="5") #6 {
entry:
  call void @onebyonecpy_hls.p0a64i8.21.22([64 x i8]* %0, [8 x i8]* align 512 %_0, [8 x i8]* align 512 %_1, [8 x i8]* align 512 %_2, [8 x i8]* align 512 %_3, [8 x i8]* align 512 %_4, [8 x i8]* align 512 %_5, [8 x i8]* align 512 %_6, [8 x i8]* align 512 %_7)
  call void @onebyonecpy_hls.p0a64i8.21.22([64 x i8]* %1, [8 x i8]* align 512 %_01, [8 x i8]* align 512 %_12, [8 x i8]* align 512 %_23, [8 x i8]* align 512 %_34, [8 x i8]* align 512 %_45, [8 x i8]* align 512 %_56, [8 x i8]* align 512 %_67, [8 x i8]* align 512 %_78)
  call fastcc void @onebyonecpy_hls.p0a1i32([1 x i32]* %2, [1 x i32]* align 512 %3)
  ret void
}

declare void @apatb_eucHW_hw([8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, i32*)

define void @eucHW_hw_stub_wrapper([8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, i32*) #7 {
entry:
  %17 = alloca [64 x i8]
  %18 = alloca [64 x i8]
  %19 = bitcast i32* %16 to [1 x i32]*
  call void @copy_out([64 x i8]* %17, [8 x i8]* %0, [8 x i8]* %1, [8 x i8]* %2, [8 x i8]* %3, [8 x i8]* %4, [8 x i8]* %5, [8 x i8]* %6, [8 x i8]* %7, [64 x i8]* %18, [8 x i8]* %8, [8 x i8]* %9, [8 x i8]* %10, [8 x i8]* %11, [8 x i8]* %12, [8 x i8]* %13, [8 x i8]* %14, [8 x i8]* %15, [1 x i32]* null, [1 x i32]* %19)
  %20 = bitcast [64 x i8]* %17 to i8*
  %21 = bitcast [64 x i8]* %18 to i8*
  %22 = bitcast [1 x i32]* %19 to i32*
  call void @eucHW_hw_stub(i8* %20, i8* %21, i32* %22)
  call void @copy_in([64 x i8]* %17, [8 x i8]* %0, [8 x i8]* %1, [8 x i8]* %2, [8 x i8]* %3, [8 x i8]* %4, [8 x i8]* %5, [8 x i8]* %6, [8 x i8]* %7, [64 x i8]* %18, [8 x i8]* %8, [8 x i8]* %9, [8 x i8]* %10, [8 x i8]* %11, [8 x i8]* %12, [8 x i8]* %13, [8 x i8]* %14, [8 x i8]* %15, [1 x i32]* null, [1 x i32]* %19)
  ret void
}
...
!4 = !{}
!5 = !DILocation(line: 29, column: 9, scope: !6)
!6 = distinct !DISubprogram(name: "eucHW", linkageName: "_Z5eucHWPhS_Pi", scope: !7, file: !7, line: 24, type: !8, isLocal: false, isDefinition: true, scopeLine: 25, flags: DIFlagPrototyped, isOptimized: false, unit: !19, variables: !4)
...
!14 = !DIFile(filename: "C:/Xilinx/Vitis_HLS/2021.1/tps/mingw/6.2.0/win64.o/nt\5Cx86_64-w64-mingw32\5Cinclude\5Cstdint.h", directory: "C:\5CUsers\5Cjuan_\5CDocuments\5CFPGA\5CJA-RM-IPD432\5CVITIS_SRCS")
...
!644 = !DILocation(line: 30, column: 9, scope: !6)
