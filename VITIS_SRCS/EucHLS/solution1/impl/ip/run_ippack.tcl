...
set solution_dir "C:/Users/juan_/Documents/FPGA/JA-RM-IPD432/VITIS_SRCS/EucHLS/solution1"
set debug_dir "C:/Users/juan_/Documents/FPGA/JA-RM-IPD432/VITIS_SRCS/EucHLS/solution1/.debug"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 y_sqrt R 0x0 "Data signal of y_sqrt" {{0 32 y_sqrt R 0 "Bit 31 to 0 of y_sqrt"}}} {0x14 y_sqrt_ctrl R 0x0 "Control signal of y_sqrt" {{0 1 y_sqrt_ap_vld R 0 "Control signal y_sqrt_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "x_0 {base_address 64 range 64} x_1 {base_address 128 range 64} x_2 {base_address 192 range 64} x_3 {base_address 256 range 64} x_4 {base_address 320 range 64} x_5 {base_address 384 range 64} x_6 {base_address 448 range 64} x_7 {base_address 512 range 64} x_8 {base_address 576 range 64} x_9 {base_address 640 range 64} x_10 {base_address 704 range 64} x_11 {base_address 768 range 64} x_12 {base_address 832 range 64} x_13 {base_address 896 range 64} x_14 {base_address 960 range 64} x_15 {base_address 1024 range 64} x_16 {base_address 1088 range 64} x_17 {base_address 1152 range 64} x_18 {base_address 1216 range 64} x_19 {base_address 1280 range 64} x_20 {base_address 1344 range 64} x_21 {base_address 1408 range 64} x_22 {base_address 1472 range 64} x_23 {base_address 1536 range 64} x_24 {base_address 1600 range 64} x_25 {base_address 1664 range 64} x_26 {base_address 1728 range 64} x_27 {base_address 1792 range 64} x_28 {base_address 1856 range 64} x_29 {base_address 1920 range 64} x_30 {base_address 1984 range 64} x_31 {base_address 2048 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 81 II x}
